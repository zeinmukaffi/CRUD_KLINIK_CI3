                ...
                <div class="card">
                    <div class="card-body p-3">
                        <div class="table-responsive">
                            <a href="<?= base_url(); ?>pasien/create" class="btn btn-primary mb-3">Tambah Data</a>
                                    ...
                                    foreach($pasien as $item) : ?>
                                        <tr>
                                            ...
                                            <td class="d-flex" style="gap: 0.5rem;">
                                                <div>
                                                    <?= anchor('pasien/edit/'.$item->id, '<div data-toggle="tooltip"
															title="Edit" class="btn btn-warning"><i class="fas fa-pen"></i></div>') ?>
                                                </div>
                                                <div>
                                                    <?= anchor('pasien/detail/'.$item->id, '<div data-toggle="tooltip"
                                                ...
                                                <div onclick="javascript: return confirm('Apakah Anda Yakin Ingin Hapus Data?')">
                                                    <?= anchor('pasien/destroy/'.$item->id, '<div data-toggle="tooltip"
