							...
							<div class="card">
								...
								<div class="card-body">
									<ul class="list-unstyled list-unstyled-border">
										...
										<li class="media">
											<img class="mr-3 rounded-circle" width="50"
												src="<?php echo base_url() ?>assets/img/avatar/avatar-4.png"
												alt="avatar">
											<div class="media-body">
									...
									<div class="row pb-2">
										<div class="col-6 col-sm-3 col-lg-3 mb-4 mb-md-0">
											<div class="avatar-item mb-0">
												<img alt="image"
													src="<?php echo base_url() ?>assets/img/avatar/avatar-5.png"
										...
										<div class="summary-item">
											...
											<ul class="list-unstyled list-unstyled-border">
												<li class="media">
													<a href="#">
														<img class="mr-3 rounded" width="50"
															src="<?php echo base_url() ?>assets/img/products/product-1-50.png"
															alt="product">
													</a>
													<div class="media-body">
												...
												<li class="media">
													<a href="#">
														<img class="mr-3 rounded" width="50"
															src="<?php echo base_url() ?>assets/img/products/product-2-50.png"
															alt="product">
													</a>
													<div class="media-body">
												...
												<li class="media">
													<a href="#">
														<img class="mr-3 rounded" width="50"
															src="<?php echo base_url() ?>assets/img/products/product-3-50.png"
															alt="product">
													</a>
													<div class="media-body">
